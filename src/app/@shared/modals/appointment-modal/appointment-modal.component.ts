...
export class AppointmentModalComponent implements AfterViewInit {
  ...
  featuredCards: any[] = [
    ...
    },
    {
      ...
      id: 22,
      description: `Become a Featured Practitioner and your practice will be featured throughout Therapist.tube`,
  ...
  nextToApplication() {
    ...
    const applicationObject = {
      appointment: {
        ...
        therapistProfileId: this.data.practitionerProfileId,
        therapistName: this.data.practitionerName,
      },
      topics: topics,
      slug: this.data.slug,
    };
